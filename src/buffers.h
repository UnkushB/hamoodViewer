...
public:
    ...
    std::vector<unsigned int> diffuesTextures;
    void createDiffuseTextures(std::unordered_map<std::string, std::vector<int>>& textureNames, std::vector<material>& materials);
};